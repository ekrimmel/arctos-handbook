---
title: Create a Meaningful GUID Prefix 
authors: Teresa Mayfield-Meyer
date_updated: 2021-07-13
redirect_from:
  - /best_practices/GUID.html
  - /best_practices/GUID
---

What is a GUID Prefix? Before you make any decisions about one, you should know what it is. Start by reading the [GUID Prefix Documentation]({% link _documentation/catalog.markdown %}#guid-prefix).

{% include tip.html content="In conjunction with catalog number the GUID Prefix forms a unique identifier within Arctos, and in conjunction with Arctos’ URI (https://arctos.database.museum/guid/) forms a Globally Unique Identifier (GUID) for the catalog record. For example: The Museum of Vertebrate Zoology's catalog record 134762 has a GUID Prefix of MVZ:Bird which forms the GUID https://arctos.database.museum/guid/MVZ:Bird:134762." %}
