---
title: Handle Organisms in Arctos
authors: Teresa J. Mayfield-Meyer
date_updated: 2024-06-11
redirect_from:
  - /how_to/Organisms.html
  - /how_to/Organisms
  - /how_to/organisms.html
  - /how_to/organisms
---

**Documentation:** [Entities]({% link _documentation/entity.markdown %})

Although many catalog records are synonymous with an organism, some are not. Parts of an individual organism may be collected at different points in time (blood samples from a zoo animal) or they may be parsed out to different collections (herbarium duplicates).
...
[Arctos Entity record GUIDs]({% link _documentation/entity.markdown %}) are currently our recommended Organism ID. An Arctos Entity record GUID is
